                    ...
                    <Disclosure.Panel className="leading-relaxed text-slate-600 dark:text-slate-500 mt-6">
                        <div className='grid grid-cols-2 md:grid-cols-2 gap-y-10'>
                            ...
                            <div>
                                ...
                                <div className="mt-1 text-sm text-slate-500">
                                    {users && users.status_perkawinan.name}
                                </div>
                            </div>
                            <div>
                                <div className="font-medium whitespace-nowrap">
                    ...
                    <Disclosure.Panel className="leading-relaxed text-slate-600 dark:text-slate-500">
                        <div className='grid grid-cols-2 md:grid-cols-2 gap-y-10'>
                            ...
                            <div>
                                ...
                                <div className="mt-1 text-sm text-slate-500">
                                    {users && users.contact_emergency.name}
                                </div>
                            </div>
                            <div>
                                <div className="font-medium whitespace-nowrap">
                            ...
                            <div>
                                ...
                                <div className="mt-1 text-sm text-slate-500">
                                    {users && users.golongan_darah.name}
                                </div>
                            </div>
                        </div>
                    </Disclosure.Panel>
                    ...
                    <Disclosure.Panel className="leading-relaxed text-slate-600 dark:text-slate-500">
                        <div className='grid grid-cols-2 md:grid-cols-2 gap-y-10'>
                            ...
                            <div>
                                ...
                                <div className="mt-1 text-sm text-slate-500">
                                    {users && users.atasan[0] ? users.atasan[0].name : 'belum di setting'}
                                </div>
                            </div>
                            <div>
                                <div className="font-medium whitespace-nowrap">
                                ...
                                <div className="mt-1 text-sm text-slate-500">
                                    {users && users.jam_operasional.name}
                                </div>
                            </div>
                            <div>
                                <div className="font-medium whitespace-nowrap">
