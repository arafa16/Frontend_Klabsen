...
const FormDataDiri = (props : any) => {
    ...
    return (
        <div className={`grid grid-cols-12 gap-4 mt-5 gap-y-5 ${statusNumber !== 1 ? 'hidden' : ''}`}>
            <div className="col-span-12 intro-y sm:col-span-3">
                <FormLabel className='text-sm' htmlFor="input-wizard-1">Absen Id *</FormLabel>
                <FormInput
                    formInputSize="sm"
                    id="absenId"
                    type="text"
            ...
            <div className="col-span-12 intro-y sm:col-span-3">
                <FormLabel htmlFor="input-wizard-3">Status Perkawinan *{statusPerkawinanId}</FormLabel>
                <FormSelect
                    formSelectSize="sm"
                    aria-label=".form-select-sm example"
