...
const ViewSlip = () => {
    ...
    useEffect(()=>{
        if(pendapatans && isPendapatansSuccess){
            setData(pendapatans);
            const totalPengeluaran = Number(pendapatans.zakat) + Number(pendapatans.iuranKoperasi) + Number(pendapatans.potonganPinjaman) + Number(pendapatans.potonganJht) + Number(pendapatans.potonganBpjs)
                                    +Number(pendapatans.potonganPensiun) + Number(pendapatans.adjustmentMinus) + Number(pendapatans.pph21) + Number(pendapatans.tunjanganJht)
                                    +Number(pendapatans.tunjanganPensiun) + Number(pendapatans.tunjanganJkk) + Number(pendapatans.tunjanganJkm) + Number(pendapatans.tunjanganBpjs)
                                    +Number(pendapatans.tax);
            
            const totalPendapatan =  Number(pendapatans.basicSalary) + Number(pendapatans.tunjanganJabatan) + Number(pendapatans.incentive) + Number(pendapatans.kjk)
                                    +Number(pendapatans.rapel) + Number(pendapatans.adjustment) + Number(pendapatans.overtimeAllowance) + Number(pendapatans.tunjanganJht)
                                    +Number(pendapatans.tunjanganPensiun) + Number(pendapatans.tunjanganJkk)+ Number(pendapatans.tunjanganJkm) + Number(pendapatans.tunjanganBpjs)
                                    +Number(pendapatans.tax);
